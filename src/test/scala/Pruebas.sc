...
val numbersLin: List[Int] = List(0, 9, 999, 55) //Unordered list
...
val equalValueLin: List[Int] = List(999, 999, 999, 999) //Identical elements list

//Test int Lists for maxIt
val numbersIt: List[Int] = List(8, 888, 44, 22) //Unordered list
...
val equalValueIt: List[Int] = List(888, 888, 888, 888) //Identical elements list
